...
Feature: View in context links in text response listings
  In order to navigate to text responses in context
  ...
  Scenario: View in context links point to the activity page when response display is own page
    ...
    And I set the field "Your answer" to "It is sunny."
    And I press "Submit"
    And I log out
