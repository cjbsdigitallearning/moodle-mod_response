...
$string['displaycompletionfull'] = 'Show full completions - all responders';
$string['displaycompletionfullgroup'] = 'Show full completions - group members';
$string['displaycompletionnone'] = 'Show nothing';
$string['displaycompletionnumber'] = 'Show the number of completions - all responders';
$string['displaycompletionnumbergroup'] = 'Show the number of completions - group members';
