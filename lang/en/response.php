...
$string['displaycompletion'] = 'Display completions before response?';
...
$string['modulename'] = 'Learning Response';
$string['modulename_help'] = 'The learning response activity module enables a teacher to pose a question, prompt for further information in a reflective fashion, and generally encourage learners to engage with content in a socially orientated manner.';
$string['modulenameplural'] = 'Learning Responses';
...
$string['pluginname'] = 'Learning Response';
$string['privacy:metadata:responsetypepluginsummary'] = 'Data for specific types of learning response.';
$string['privacy:metadata:responseuser'] = 'A record of a user answering a learning response activity';
